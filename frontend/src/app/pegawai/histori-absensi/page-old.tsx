...
export default function HistoriAbsensiPage() {
  ...
  }, [user, currentPage, selectedType, selectedStatus, dateFrom, dateTo, pageSize])
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 dark:from-gray-900 dark:via-gray-800 dark:to-slate-900 p-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-6 gap-4">
              ...
              <div>
                ...
                <Select value={selectedType} onValueChange={setSelectedType}>
                  <SelectTrigger>
                    <SelectValue placeholder="Jenis Absensi" />
                  </SelectTrigger>
                  <SelectContent>
